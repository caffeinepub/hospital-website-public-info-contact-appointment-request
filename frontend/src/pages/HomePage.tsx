      ...
      <section className="section-spacing">
        <div className="container">
          <div className="text-center space-y-4 mb-16">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold">Why Choose Mahalaxmi Health Care</h2>
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4 max-w-7xl mx-auto">
            {trustSignals.map((signal) => (
              <Card key={signal.title} className="text-center hover:shadow-lg transition-shadow">
      ...
      <section className="section-spacing bg-muted/30">
        <div className="container">
          <div className="text-center space-y-4 mb-12">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold">State-of-the-Art Facilities</h2>
            <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
              Modern infrastructure and advanced medical equipment for superior care
            </p>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-2 max-w-6xl mx-auto">
            <div className="relative overflow-hidden rounded-xl shadow-lg group">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end">
                <div className="p-6 text-white">
                  <h3 className="text-2xl font-bold mb-2">Welcoming Reception</h3>
                  <p className="text-white/90">Comfortable and modern patient reception area</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative overflow-hidden rounded-xl shadow-lg group">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end">
                <div className="p-6 text-white">
                  <h3 className="text-2xl font-bold mb-2">Advanced Equipment</h3>
                  <p className="text-white/90">Latest medical technology for accurate diagnosis</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative overflow-hidden rounded-xl shadow-lg group md:col-span-2">
              <img
                src={withCacheBust('/assets/generated/doctor-consultation.dim_1200x800.png')}
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end">
                <div className="p-6 text-white">
                  ...
                  <p className="text-white/90">Private consultation rooms with experienced medical professionals</p>
                </div>
              </div>
            </div>
          </div>
