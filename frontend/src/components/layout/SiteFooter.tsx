...
export default function SiteFooter() {
  ...
  const logoUrl = withCacheBust('/assets/generated/mhc-logo-hq.dim_512x512.png');
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <div className="text-destructive font-medium mt-1">Emergency: 24/7</div>
                </div>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              ...
              <li className="flex items-start gap-2">
                ...
                <a href="mailto:info@mahalaxmihealthcare.com" className="hover:text-primary transition-colors break-all">
                  info@mahalaxmihealthcare.com
                </a>
              </li>
              <li className="flex items-start gap-2">
                <MapPin className="h-4 w-4 mt-0.5 flex-shrink-0" aria-hidden="true" />
                <span>123 Healthcare Avenue, Medical District, City, State 123456</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
            ...
            <div className="flex items-center gap-2">
              ...
              <Heart className="h-4 w-4 text-destructive fill-destructive" aria-label="love" />
              <span>using</span>
              <a
                href={caffeineUrl}
                target="_blank"
