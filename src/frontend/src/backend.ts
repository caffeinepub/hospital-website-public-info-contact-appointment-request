...
export class Backend implements backendInterface {
    ...
    async getAppointmentById(arg0: Time): Promise<AppointmentRequest> {
        if (this.processError) {
            try {
    ...
    async getContactById(arg0: Time): Promise<Contact> {
        if (this.processError) {
            try {
    ...
    async getDomainDraft(): Promise<DomainDraft | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getDomainDraft();
    ...
    async saveDomainDraft(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveDomainDraft(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitAppointmentRequest(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitAppointmentRequest(arg0, arg1, arg2, arg3, to_candid_opt_n11(this._uploadFile, this._downloadFile, arg4));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_DomainDraft]): DomainDraft | null {
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        departmentService: value.departmentService,
