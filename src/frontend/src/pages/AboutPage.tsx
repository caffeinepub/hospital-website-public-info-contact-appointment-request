          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-primary/5 border border-primary/15 rounded-2xl p-8 md:p-12 space-y-6">
              ...
              <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
                Mahalaxmi Health Care (Occupational health care and wellness
                service provider) is a division of Mahalaxmi Multi Specialty
                Hospital, first of its kind in Healthcare Industry. Mahalaxmi
                Health Care is managing a health centre or running Onsite Health
                Check-ups are not at all a challenge to us. Mahalaxmi Health
                Care (Occupational health care and wellness service provider)
                division was formed to bridge the gap between the "Industry's
                Requirement" and the services provided by Hospitals, which was
                studied in careful analysis from the extensive experience of our
                Managing Director in running Multispecialty Hospitals &amp;
                OHC's. We can assist you in setting up OHC's, running it with
                required no of Doctors (full time/Part time), Paramedical staff,
                run LAB &amp; Pharmacy, conduct Pre-Employment Examination,
                Periodic Health Check up of the EMPLOYEES on-site, organize
                Doctors Talk, Health Awareness Sessions, Free Screening Camps
                for the employees &amp; their families, etc.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid gap-8 lg:grid-cols-2 max-w-7xl mx-auto items-center">
              ...
              <Card className="hover:shadow-lg transition-shadow border-primary/20">
                ...
                <CardContent>
                  <p className="text-muted-foreground leading-relaxed text-lg">
                    To deliver compassionate, high-quality healthcare services
                    that improve the health and wellbeing of our community
                    through excellence in medical care, education, and
                    innovation.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-shadow border-secondary/20">
                ...
                <CardContent>
                  <p className="text-muted-foreground leading-relaxed text-lg">
                    ...
                    recognized for our commitment to patient-centered care,
                    medical excellence, and continuous improvement in healthcare
                    delivery.
                  </p>
                </CardContent>
              </Card>
            ...
            <div className="space-y-6">
              <div className="relative overflow-hidden rounded-xl shadow-lg">
                <img
                  src={withCacheBust(
                    "/assets/generated/hospital-corridor.dim_1200x800.png",
                  )}
              ...
              <div className="relative overflow-hidden rounded-xl shadow-lg">
                <img
                  src={withCacheBust(
                    "/assets/generated/doctor-patient-consult.dim_1200x800.png",
                  )}
              ...
              <div className="relative overflow-hidden rounded-xl shadow-lg">
                <img
                  ...
                  alt="Hospital laboratory facility"
                  className="w-full h-64 object-cover"
                />
              </div>
            </div>
        ...
        <div className="container">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              A look at our modern facilities and dedicated team
            </p>
          </div>
        ...
        <div className="container">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 max-w-7xl mx-auto">
            <Card className="hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Comprehensive health assessments to ensure workplace fitness
            ...
            <Card className="hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Immediate treatment and rehabilitation for work-related
                  injuries
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Structured support for safe and effective workplace
                  reintegration
                </p>
              </CardContent>
            </Card>
